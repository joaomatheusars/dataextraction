...
SCHEMA_PATH = Path('C:/Users/joaom/OneDrive/Nova pasta/extractdata/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\joaom\\.cache\\prisma-python\\binaries\\5.8.0\\0a83d8541752d7582de2ebc1ece46519ce72a848\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    product_history: 'actions.Product_HistoryActions[models.Product_History]'
    ...
    def __init__(
        ...
        *,
        ...
        self.product_history = actions.Product_HistoryActions[models.Product_History](self, models.Product_History)
...
class Batch:
    ...
    product_history: 'Product_HistoryBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.product_history = Product_HistoryBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class Product_HistoryBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.Product_HistoryCreateInput,
        include: Optional[types.Product_HistoryInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Product_History,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.Product_HistoryCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.Product_HistoryWhereUniqueInput,
        include: Optional[types.Product_HistoryInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.Product_HistoryUpdateInput,
        where: types.Product_HistoryWhereUniqueInput,
        include: Optional[types.Product_HistoryInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.Product_HistoryWhereUniqueInput,
        data: types.Product_HistoryUpsertInput,
        include: Optional[types.Product_HistoryInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.Product_HistoryUpdateManyMutationInput,
        where: types.Product_HistoryWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Product_History,
    ...
    def delete_many(
        self,
        where: Optional[types.Product_HistoryWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Product_History,
