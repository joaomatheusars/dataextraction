...
class BaseProduct_History(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Product_History']] = 'Product_History'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.Product_HistoryActions[_PrismaModelT]':
        from .client import get_client

        return actions.Product_HistoryActions[_PrismaModelT](client or get_client(), cls)
